...
const buildTemplates = {
    ...
    Marksman: {
        ...
        itemBuilds: {
            ...
            core: { items: [3031, 3094, 3036], names: ['Infinity Edge', 'RFC', 'LDR'], order: 'Noonquiver → IE → Zeal item' },
            situational: {
    ...
    Mage: {
        ...
        itemBuilds: {
            ...
            core: { items: [223116, 4645, 3089], names: ["Luden's Companion", 'Shadowflame', 'Rabadon'], order: "Lost Chapter → Luden's → Shadowflame" },
            situational: {
                vsBurst: { items: [3102], when: 'Contre burst mages' },
                vsDive: { items: [3157], when: 'Contre assassins/divers' },
                vsHeal: { items: [3165], when: 'Contre healing' }
            },
            boots: [3020],
            fullBuild: { standard: [3020, 223116, 4645, 3089, 3135, 3157], names: ['Sorc', "Luden's", 'Shadowflame', 'Rabadon', 'Void Staff', "Zhonya's"] }
        },
    ...
    Assassin: {
        ...
        itemBuilds: {
            ...
            core: { items: [223137, 3142, 6692], names: ['Hubris', "Youmuu's", 'Eclipse'], order: 'Dirk → Hubris → Youmuu' },
            situational: {
                vsShields: { items: [6609], when: 'Contre shields (Lulu, Shieldbow)' },
                survie: { items: [3814], when: 'Besoin de spell shield' }
            },
            boots: [3158],
            fullBuild: { standard: [3158, 223137, 3142, 6692, 3814, 6609], names: ['CDR Boots', 'Hubris', 'Youmuu', 'Eclipse', 'Edge of Night', 'Serpent'] }
        },
    ...
    Tank: {
        ...
        itemBuilds: {
            starter: { items: [1054, 2003], names: ["Doran's Shield", 'Potion'] },
            core: { items: [223110, 3075, 3065], names: ['Iceborn Gauntlet', 'Thornmail', 'Spirit Visage'], order: 'Bami → Iceborn → situational' },
            situational: {
            ...
            boots: [3047],
            fullBuild: { standard: [3047, 223110, 3075, 3065, 3143, 3083], names: ['Plated', 'Iceborn', 'Thornmail', 'Spirit', 'Randuin', 'Warmog'] }
        },
    ...
    APAssassin: {
        ...
        itemBuilds: {
            starter: { items: [1056, 2003], names: ["Doran's Ring", 'Potion'] },
            core: { items: [223089, 3100, 3089], names: ['Stormsurge', 'Lich Bane', 'Rabadon'], order: 'Alternator → Stormsurge → Lich' },
            situational: {
                survie: { items: [3157], when: 'Besoin de Zhonya' },
                burst: { items: [4645], when: 'More burst' }
            },
            boots: [3020],
            fullBuild: { standard: [3020, 223089, 3100, 3089, 3157, 3135], names: ['Sorc', 'Stormsurge', 'Lich Bane', 'Rabadon', "Zhonya's", 'Void Staff'] }
        },
...
const championOverrides = {
    ...
    Zed: {
        ...
        itemBuilds: {
            ...
            core: { items: [6692, 6630, 6694], names: ['Voltaic Cyclosword', 'Eclipse', 'Axiom Arc'], order: 'Voltaic → Eclipse' },
            boots: [3158],
            fullBuild: { standard: [3158, 6692, 6630, 6694, 6695, 3814], names: ['CDR Boots', 'Voltaic', 'Eclipse', 'Axiom', "Serylda's", 'Edge of Night'] }
        },
    ...
    Taliyah: {
        tier: 'B', difficulty: 'Hard', role: 'Mage',
    ...
    Malphite: {
        ...
        itemBuilds: {
            ...
            boots: [3047],
            fullBuild: { standard: [3047, 3068, 3110, 3075, 4401, 6662], names: ['Plated', 'Sunfire', 'Frozen Heart', 'Thornmail', 'FoN', 'JakSho'] }
        },
    ...
    LeeSin: {
        ...
        itemBuilds: {
            ...
            core: { items: [6692, 6610, 3111], names: ['Eclipse', 'Sundered Sky', "Mercury's Treads"], order: 'Eclipse → Sundered' },
            boots: [3111],
    ...
    Viego: {
        ...
        itemBuilds: {
            starter: { items: [1102, 2003], names: ['Gustwalker Hatchling', 'Potion'] },
            core: { items: [6672, 3009, 6610], names: ['Kraken Slayer', 'The Collector', 'Sundered Sky'], order: 'Kraken → Collector' },
            boots: [3047],
            fullBuild: { standard: [3047, 6672, 3009, 6610, 3053, 3091], names: ['Plated', 'Kraken', 'Collector', 'Sundered', "Sterak's", "Wit's End"] }
        },
